...
parser.add_argument('--epoch', dest='epoch', type=int, default=500, help='# of epoch')  # 训练的epoch数量
...
parser.add_argument("--lamda_l1_weight", type=float, default=100, help="L1 lamda")  # 训练中L1_Loss前的乘数0.0
